...
@Component({
  ...
  template: `
    <div class="primary-card" (click)="cardClick.emit($event)">
      <div class="primary-card-accent" *ngIf="accentColor" [style.background]="accentColor"></div>
  ...
  `,
  styles: [`
    primary-card { display: block; min-width: 0; }
    ...
    primary-card .primary-card:active { transform: scale(0.98); }
    primary-card .primary-card-accent { width: 5px; flex-shrink: 0; }
