export const API = {
    ...
    GET_MEMBERSHIPS_BY_CLUB: `membership/getMembershipsByClub`,
    ...
    GET_MEMBERSHIP_MONTHS: `membership/getMembershipMonths`,
    ...
    GET_ACTIVE_SUBSCRIPTIONS: `monthly_session/get-active-subscriptions`,
    ...
    SAVE_VENUE_ASSIGNMENTS: `coach/save-venue-assignments`,
    GET_VENUE_ASSIGNMENTS: `coach/get-venue-assignments`,
    ...
    UPDATE_VENUE: 'club/update_venue',
    ...
    GET_FEATURE_ANNOUNCEMENTS: 'feature-announcement/get-active',
    MARK_FEATURE_ANNOUNCEMENT_SHOWN: 'feature-announcement/mark-shown',
    SUPPRESS_FEATURE_ANNOUNCEMENT: 'feature-announcement/suppress',
    ...
    UPDATE_STANDALONE_PARTICIPATION_STATUS:
      "match/UpdateStandaloneParticipationStatus",
    PUBLISH_RESULT_STANDALONE: "match/PublishResultStandAlone",
    UPDATE_TEAM_MATCH_PARTICIPANT_PAYMENT:
      "match/UpdateTeamMatchParticipantPayment",
    ...
    LOCATION_PLACE_DETAILS: 'location/getplacedetails',
    SUPERADMIN_SYNC_GLOBAL_PROMOTION: 'superadmin/sinkglobalpromotion',
    SESSION_PRINT_REPORT: 'session/printreport',
    HOLIDAYCAMP_PRINT_SESSION_MEMBER_REPORT: 'Holidaycamp/printsessionmembereport',
