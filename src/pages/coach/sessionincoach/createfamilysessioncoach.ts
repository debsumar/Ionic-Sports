...
@IonicPage()
@Component({
    selector: 'createfamilysessioncoach-page',
    templateUrl: 'createfamilysessioncoach.html'
})

export class CoachCreateFamilySession {
...
cancelSessionCreation(){
    ...
    createSession() {
        ...
        this.navCtrl.push("CoachAddMemberFamilySession", { ParentClubKey: this.sessionDetails.ParentClubKey, ClubKey: this.sessionDetails.ClubKey, CoachKey: this.sessionDetails.CoachKey, SessionKey: this.returnKey, SessionName: this.sessionDetails.SessionType, SessionDetials: this.sessionDetails });
