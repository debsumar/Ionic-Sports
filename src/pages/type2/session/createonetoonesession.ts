...
@IonicPage()
@Component({
    selector: 'createonetoonesession-page',
    templateUrl: 'createonetoonesession.html'
})

export class Type2CreateOneToOneSession {
    themeType: number;
...
cancelSessionCreation(){
    ...
    //Done 
    getClubList() {
        const parentclub$Obs = this.fb.getAllWithQuery("/Club/Type2/" + this.parentClubKey, { orderByChild: "IsEnable", equalTo: true }).subscribe((data) => {
    ...
    createSession() {
        ...
        this.sessionDetails.SessionType = "OneToOne";
        ...
        this.navCtrl.push("Type2AddMemberOneToOneSession", { ParentClubKey: this.sessionDetails.ParentClubKey, ClubKey: this.sessionDetails.ClubKey, CoachKey: this.sessionDetails.CoachKey, SessionKey: this.returnKey, SessionName: this.sessionDetails.SessionType, SessionDetials: this.sessionDetails });
