...
@IonicPage()
@Component({
  selector: 'addmemberonetoone-page',
  templateUrl: 'addmemberonetoone.html'
})

export class Type2AddMemberOneToOneSession {
  themeType: number;
  ...
  getMemberList() {
    const member$Obs = this.fb.getAll("/Member/" + this.parentClubKey + "/" + this.clubKey).subscribe((data) => {
