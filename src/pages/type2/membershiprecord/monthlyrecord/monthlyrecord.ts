...
export class MonthlyRecord {
    ...
    getMonthDetails(){    
        const get_memberships_payload = {
          ...
          this.httpService.post(API.GET_MEMBERSHIP_MONTHS,get_memberships_payload).subscribe((res: any) => {
    ...
    cancelMembership() {
            this.httpService.post(API.CANCEL_MEMBERSHIP, { membership_package_id: this.membership_user.membership_package_id }).subscribe((res) => {
            this.comonService.hideLoader();
