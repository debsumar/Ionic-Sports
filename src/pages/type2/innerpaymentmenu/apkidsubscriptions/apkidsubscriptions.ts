...
export class Apkidsubscriptions {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private apollo: Apollo, private httpLink: HttpLink, public commonService: CommonService, public storage: Storage, private events: Events, private themeService: ThemeService) {
  ...
  applyTheme() {
    const el = document.querySelector('page-apkidsubscriptions');
    if (el) {
      if (this.isDarkTheme) {
