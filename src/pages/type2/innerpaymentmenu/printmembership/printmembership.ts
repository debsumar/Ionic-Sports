...
export class PrintmembershipPage {
  ...
  userObj:any = "";
  constructor(public sharedservice: SharedServices, public loadingCtrl:LoadingController, public navCtrl: NavController, public navParams: NavParams, public fb: FirebaseService,public toastCtrl:ToastController,public actionSheetCtrl:ActionSheetController,public storage:Storage, private httpService: HttpService) {
