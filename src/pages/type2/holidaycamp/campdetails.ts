...
export class Type2CampDetails {
  ...
  applyTheme() {
    const pageElement = document.querySelector('campdetails-page');
    if (pageElement) {
...
//copy req navigation
  ...
  notificationToCampMember() {
    this.notificationToCampMembers();
  }
