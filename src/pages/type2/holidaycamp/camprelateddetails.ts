...
import { ViewController, NavController, Slides, Platform, ActionSheetController, Events } from "ionic-angular";
...
export class CampRelatedDetailsPage {
  ...
  applyTheme(isDark: boolean) {
    this.isDarkTheme = isDark;
    const pageElement = document.querySelector('page-camprelateddetails');
    if (pageElement) {
