  ...
  HolidayCampPendingPayment() {
    ...
    this.httpService.post(`${API.EnrolmentDetails}`, this.holdiayCampPendingPaymentInput).subscribe((res: any) => {
      if (res) {
        ...
        this.commonService.toastMessage(
          `${this.holidaycampPendingPaymentRes.totalCount} Hoiday Cammps Found`,
          2500,
          ToastMessageType.Success,
          ToastPlacement.Bottom
        );
...
//   selectedType: number = 0;
//   currencyDetails: any = "";
//   clubmap: Map<any, any> = new Map();
//   selectedParentClubKey: any;
//   selectedMenu = 'session';
//   family_members: FamilyMember[] = [];
//   member_info: VenueUser;
//   menus = [{ name: 'Term Sessions', module: 0 },
//   { name: 'Weekly Sessions', module: 1 },
//   { name: 'Monthly Sessions', module: 5 },
//   { name: 'Holiday Camps', module: 2 },
//   { name: 'Facility Bookings', module: 3 },
...
//   //   const club$Obs = this.fb.getAllWithQuery("/Club/Type2/" + this.selectedParentClubKey, { orderByChild: "IsEnable", equalTo: true }).subscribe((data) => {
//   //     club$Obs.unsubscribe();
//   //     if(data.length > 0){
//   //       let clubs = data;
//   //       clubs.forEach(club => {
//   //         this.clubmap.set(club.$key, club.ClubName)
//   //       })
...
//       this.getTermSessionBookings();
//     }
//     else if (Number(this.selectedType == 1)) { //weekly_sessions
//       this.courtbookingactive = false;
//       this.getWeeklySessionBookings();
//     }
//     else if (Number(this.selectedType == 2)) { //holidaycams
//       this.courtbookingactive = false;
//       this.getHolidayCampsBookings();
//     }
//     else if (Number(this.selectedType == 3)) {
//       this.getCourtBookingHistory();
//     } else if (Number(this.selectedType == 4)) { //school sessions
//       this.getSchoolSessionBookings();
//     } else {//monthly sessions
//       this.getMonthlySessionBookings();
//     }
...
//   //getting term session details of parent&family by parent postgre_id & firebasekey
//   getTermSessionBookings() {
//     this.httpService.post(`${API.BOOKING_HISTORY}/term`, this.booking_input).subscribe((result: any) => {
...
//     }, (error) => {
//       this.commonService.toastMessage("termsession fetch failed", 3000, ToastMessageType.Error, ToastPlacement.Bottom);
//     })
//   }

//   getWeeklySessionBookings() {
//     this.httpService.post(`${API.BOOKING_HISTORY}/weekly`, this.booking_input).subscribe((result: any) => {
//       console.log("time ended");
...
//       this.historyObj.PaidAmount = amount.toString();
//       this.historyObj.Discount = discount.toString();
//       // this.historyObj.PaidAmount = (this.weekly_session_list[0].amount_paid).toString();
//       // this.historyObj.Discount = this.weekly_session_list[0].total_discount.toString();

//     }, (error) => {
//       this.commonService.toastMessage("weeklysession fetch failed", 3000, ToastMessageType.Error, ToastPlacement.Bottom);
//     })

//   }

//   getMonthlySessionBookings() {
//     this.httpService.post(`${API.BOOKING_HISTORY}/monthly`, this.booking_input).subscribe((result: any) => {
//       console.log("time ended");
...
//   getHolidayCampsBookings() {
//     this.httpService.post(`${API.BOOKING_HISTORY}/holidaycamp`, this.booking_input).subscribe((result: any) => {
//       console.log("time ended");
//       this.holidaycamp_list = [...result.data, ...this.holidaycamp_list];
//       let amount = 0;
//       let discount = 0;
...
//     }, (err) => {
//       //this.commonService.hideLoader();
//       this.commonService.toastMessage("holidaycamps fetch failed", 3000, ToastMessageType.Error, ToastPlacement.Bottom);
//     });
//   }

//   getSchoolSessionBookings() {

//     this.httpService.post(`${API.BOOKING_HISTORY}/school`, this.booking_input).subscribe((result: any) => {
//       console.log("time ended");
...
//     }, (error) => {
//       this.commonService.toastMessage("schoolsession fetch failed", 3000, ToastMessageType.Error, ToastPlacement.Bottom);
...
//   getSessionDetails(bookings) {
//     //geting session details....
//     if (Number(this.selectedType) === 0) {

//     }


//     if (Number(this.selectedType) == 1) { //weeklysessions


//     }

//     //getting holidaycamp details...
//     if (Number(this.selectedType) === 2) { //Holidaycamps


//     }
//     //getting schoolsession details...
//     if (Number(this.selectedType) === 4) {
...
//     this.historyObj.DueAmount = "0.00";
//     this.historyObj.Discount = "0.00";
//     this.getPaymentDetails();//commented 
//   }

//   getPaymentDetails() {
//     // if (this.term_session_list.length > 0) {
//     //   for (let session = 0; session < this.term_session_list.length; session++) {
//     //     if(this.term_session_list[session].is_paid && this.term_session_list[session].payment && this.term_session_list[session].payment.amount_paid){
//     //       this.historyObj.PaidAmount = String(parseFloat(this.historyObj.PaidAmount) + parseFloat(this.term_session_list[session].payment.amount_paid));
//     //       this.historyObj.Discount = String(parseFloat(this.historyObj.Discount) + parseFloat(this.term_session_list[session].payment.total_discount));
//     //     }else{
//     //       this.historyObj.DueAmount = String(parseFloat(this.historyObj.DueAmount) + parseFloat(this.term_session_list[session].amount_due));
//     //     }
//     //   }
//     // }
//     // if (this.weekly_session_list.length > 0) {
//     //   for (let weeklySession = 0; weeklySession < this.weekly_session_list.length; weeklySession++) {
//     //     if (this.weekly_session_list[weeklySession].Paid == undefined || isNaN(parseFloat(this.weekly_session_list[weeklySession].Paid))) {
//     //       this.weekly_session_list[weeklySession].Paid = "0.00";
//     //     }
//     //     if (this.weekly_session_list[weeklySession].Due == undefined || isNaN(parseFloat(this.weekly_session_list[weeklySession].Due))) {
//     //       this.weekly_session_list[weeklySession].Due = "0.00";
//     //     }
//     //     if (this.weekly_session_list[weeklySession].Discount == undefined || isNaN(parseFloat(this.weekly_session_list[weeklySession].Discount))) {
//     //       this.weekly_session_list[weeklySession].Discount = "0.00";
//     //     }
//     //     if (this.weekly_session_list[weeklySession].PaymentDate == "Invalid date") {
//     //       this.weekly_session_list[weeklySession].PaymentDate == ""
//     //     }
//     //     this.historyObj.Discount = String(parseFloat(this.historyObj.Discount) + parseFloat(this.weekly_session_list[weeklySession].Discount));
//     //     this.historyObj.PaidAmount = String(parseFloat(this.historyObj.PaidAmount) + parseFloat(this.weekly_session_list[weeklySession].Paid));
//     //     this.historyObj.DueAmount = String(parseFloat(this.historyObj.DueAmount) + parseFloat(this.weekly_session_list[weeklySession].Due));
//     //     if(parseFloat(this.weekly_session_list[weeklySession].Due) > 0.00){
//     //       console.log(`sclsession:${this.weekly_session_list[weeklySession].SessionKey}:${parseFloat(this.weekly_session_list[weeklySession].Due)}`)
//     //     }
//     //   }
//     // }
//     // if (this.holidaycamp_list.length > 0) {
//     //   for (let holidayCamp = 0; holidayCamp < this.holidaycamp_list.length; holidayCamp++) {
//     //     if (this.holidaycamp_list[holidayCamp].PaymentDate == "Invalid date") {
//     //       this.holidaycamp_list[holidayCamp].PaymentDate == ""
//     //     }
//     //     if (this.holidaycamp_list[holidayCamp].Paid == undefined || isNaN(parseFloat(this.holidaycamp_list[holidayCamp].Paid))) {
//     //       this.holidaycamp_list[holidayCamp].Paid = "0.00";
//     //     }
//     //     if (this.holidaycamp_list[holidayCamp].Due == undefined || isNaN(parseFloat(this.holidaycamp_list[holidayCamp].Due))) {
//     //       this.holidaycamp_list[holidayCamp].Due = "0.00";
//     //     }
//     //     if (this.holidaycamp_list[holidayCamp].Discount == undefined || isNaN(parseFloat(this.holidaycamp_list[holidayCamp].Discount))) {
//     //       this.holidaycamp_list[holidayCamp].Discount = "0.00";
//     //     }

//     //     this.historyObj.PaidAmount = String(parseFloat(this.historyObj.PaidAmount) + parseFloat(this.holidaycamp_list[holidayCamp].Paid));
//     //     if(parseFloat(this.holidaycamp_list[holidayCamp].Due) > 0.00){
//     //       console.log(`camp:${this.holidaycamp_list[holidayCamp].SessionKey}:${parseFloat(this.holidaycamp_list[holidayCamp].Due)}`)
//     //     }
//     //     this.historyObj.DueAmount = String(parseFloat(this.historyObj.DueAmount) + parseFloat(this.holidaycamp_list[holidayCamp].Due));
//     //     this.historyObj.Discount = String(parseFloat(this.historyObj.Discount) + parseFloat(this.holidaycamp_list[holidayCamp].Discount));
//     //   }
//     // }
//     // if (this.school_session_list.length > 0) {
//     //   for (let schoolSession = 0; schoolSession < this.school_session_list.length; schoolSession++) {
//     //     if (this.school_session_list[schoolSession].Paid == undefined || isNaN(parseFloat(this.school_session_list[schoolSession].Paid))) {
//     //       this.school_session_list[schoolSession].Paid = "0.00";
//     //     }
//     //     if (this.school_session_list[schoolSession].Due == undefined || isNaN(parseFloat(this.school_session_list[schoolSession].Due))) {
//     //       this.school_session_list[schoolSession].Due = "0.00";
//     //     }
//     //     if (this.school_session_list[schoolSession].Discount == undefined || isNaN(parseFloat(this.school_session_list[schoolSession].Discount))) {
//     //       this.school_session_list[schoolSession].Discount = "0.00";
//     //     }
//     //     if (this.school_session_list[schoolSession].PaymentDate == "Invalid date") {
//     //       this.school_session_list[schoolSession].PaymentDate == ""
//     //     }
//     //     this.historyObj.Discount = String(parseFloat(this.historyObj.Discount) + parseFloat(this.school_session_list[schoolSession].Discount));
//     //     this.historyObj.PaidAmount = String(parseFloat(this.historyObj.PaidAmount) + parseFloat(this.school_session_list[schoolSession].Paid));
//     //     this.historyObj.DueAmount = String(parseFloat(this.historyObj.DueAmount) + parseFloat(this.school_session_list[schoolSession].Due));
//     //     if(parseFloat(this.school_session_list[schoolSession].Due) > 0.00){
//     //       console.log(`sclsession:${this.school_session_list[schoolSession].SessionKey}:${parseFloat(this.school_session_list[schoolSession].Due)}`)
//     //     }
//     //   }
//     // }
//     // //this.selectedTab = this.sessionList;
//     // this.historyObj.Discount = Number(this.historyObj.Discount).toFixed(2);
//     // this.historyObj.DueAmount = Number(this.historyObj.DueAmount).toFixed(2);
//     // this.historyObj.PaidAmount = Number(this.historyObj.PaidAmount).toFixed(2);
//     // this.weekly_session_list.reverse();
//     // this.holidaycamp_list.reverse();
//     // this.school_session_list.reverse();
//     // console.log(`total due:${parseFloat(this.historyObj.DueAmount)}`)
//   }

//   getCourtBookingHistory() {
//     console.log("court booking function called");
//     let UserBookingsInput = {
//       parentclub_id: this.selectedParentClubKey,
//       member_id: this.member_info.parentFirebaseKey
//     }
...
//     }
//     `;
//     this.graphqlService.query(getCourtBooking, { bookingInput: UserBookingsInput }, 0)
//       .subscribe((res: any) => {
//         //  this.commonService.hideLoader();
//         this.court_booking_list = res.data.getPastBookingForMember;

//         console.log("length of court booking function is:", this.court_booking_list.length)

//         // console.log("Court booking data is:",JSON.stringify(this.courtbooking ));
