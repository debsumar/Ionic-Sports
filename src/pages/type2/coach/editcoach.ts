...
import { NavController, AlertController, PopoverController, ToastController, Toast, Events } from 'ionic-angular';
...
export class Type2EditCoach {
  ...
  applyTheme(isDark: boolean) {
    this.isDarkTheme = isDark;
    const pageElement = document.querySelector('editcoach-page');
    if (pageElement) {
