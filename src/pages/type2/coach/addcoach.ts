...
import { NavController, PopoverController, LoadingController,ToastController, Events } from 'ionic-angular';
...
export class Type2AddCoach {
  ...
  applyTheme(isDark: boolean) {
    this.isDarkTheme = isDark;
    const pageElement = document.querySelector('addcoach-page');
    if (pageElement) {
